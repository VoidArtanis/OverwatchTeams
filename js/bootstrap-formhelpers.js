    ...
    addBootstrapCountries: function() {
      ...
      if (this.options.blank === true) {
        ...
        if (this.options.addall === true) {
            $options.append('<li><a tabindex="-1" href="#" data-option="all"><i class="glyphicon"></i>All Countries</a></li>');
        }
  ...
  BFHSelectBox.prototype = {
    ...
    initSelectBox: function () {
      ...
      if (this.options.filter === true) {
        this.$element.find('.bfh-selectbox-options').prepend('<div class="bfh-selectbox-filter-container"><input type="text" class="bfh-selectbox-filter form-control"></div>').focus();
      }
...
$(document).ready(function () {
    $('.bfh-selectbox').on('shown.bfhselectbox', function () {
        setTimeout(function() {  $('.bfh-selectbox-filter')[0].focus() }, 200);
       ;
    });
});