...
@section('content')
    ...
    <div class=" text-center" style="margin-top: 100px; height: 80vh">
        <div class="center">
            <h2>Team Confirmed!</h2>
            <h4>Now that the team is registered, tell your team mates to join and accept the team request!</h4>
            <h4>When all the team members accept the request, the team will be active.</h4>
